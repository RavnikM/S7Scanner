    ...
    szl_dict = {
        0x11:
                { 'title': 'Module Identification',
                  ...
                  'packer': {
                      (1, 6): lambda packet: "{0:s} v.{2:d}.{3:d}".format(packet[:20].decode("utf-8"),
                                                                          *unpack(">HBBH", packet[20:])),
                      (7,): lambda packet: "{0:s} v.{3:d}.{4:d}.{5:d}".format(packet[:20].decode("utf-8"),
                                                                              *unpack(">HBBBB", packet[20:]))
                  }
                },
        0x1c:
                { 'title': 'Component Identification',
                  ...
                  'packer': {
                      (1, 2, 5): lambda packet: packet[:24].decode("utf-8"),
                      (3, 7, 8): lambda packet: packet[:32].decode("utf-8"),
                      (4,): lambda packet: packet[:26].decode("utf-8")
                  }
                }
    }
